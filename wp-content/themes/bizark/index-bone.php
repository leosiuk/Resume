            ...
            <h1>
                <?php 
                    if( of_get_option('welcome_headline') ){
                        ...
                        _e('Welcome Headline Comes Here',  'BizArk');
                    }
                ?>    
            </h1>
            ...
            <p>
                <?php 
                    if( of_get_option('welcome_text') ){
                        ...
                        _e('You can change this text in welcome text box of welcome section block in Biz one tab of theme options page. You can change this text in welcome text box of welcome section block in Biz two tab of theme options page.',  'BizArk');
                    }
                ?>                                
            </p>    
                ...
                <div class="biz0ne-products-services-description">
                                                    <?php 
                                                        if( of_get_option('left_section_text') ){
                                                            ...
                                                            _e('You can change this text in description box of left section block in Biz two tab of theme options page.',  'BizArk');
                                                        }
                                                    ?>        
                ...
                <div class="biz0ne-products-services-description">
                                                    <?php 
                                                        if( of_get_option('center_section_text') ){
                                                            ...
                                                            _e('You can change this text in description box of center section block in Biz two tab of theme options page.',  'BizArk');
                                                        }
                                                    ?>       
                </div><!-- .biz0ne-products-services-description -->                
                ...
                <div class="biz0ne-products-services-description">
                                                    <?php 
                                                        if( of_get_option('right_section_text') ){
                                                            ...
                                                            _e('You can change this text in description box of right section block in Biz two tab of theme options page.',  'BizArk');
                                                        }
                                                    ?>        
                </div><!-- .biz0ne-products-services-description -->                
                ...
                <p>
                    <?php 
                         if( of_get_option('quote_section_text') ){
                              ...
                              _e('You can change this text in quote box of quote section block in Biz two tab of theme options page. You can change this text in quote box of quote section block in Biz two tab of theme options page.',  'BizArk');
                         }
                    ?>
                </p> 
