...
function multipurpose_gallery($params){
    $html = "";  
    $n = 0;
    ...
    if(isset($params['ids'])){
        ...
        foreach($ids as $id){
            ...
            $active = ($n++==0)?'active':'';
            $html .= "<div class='item {$active}'><a href='{$image[0]}' rel='image-preview-{$post_id}' class='imgpreview'><img src='".multipurpose_thumb_url($image[0], array(900, 500))."' /></a></div>";
...
add_shortcode( 'gallery', 'multipurpose_gallery',9);
